...
├── course-player.html     # Course learning page
...
### 2. Browse Courses
- Navigate to "Courses" from the menu
...
### 4. Take Quizzes
- Go to "Quizzes" from dashboard
- Complete timed quizzes
- Earn bonus XP for good scores
...
| 📊 Data Science | Data Science Bootcamp |
| 🤖 AI/ML | Machine Learning, Deep Learning |
| 🌐 Web Development | Full Stack Development |
| 🔒 Cybersecurity | Security Fundamentals |
| 🎨 UI/UX Design | Design Masterclass |

## 🏆 Achievements

- 🎯 **First Steps** - Enroll in your first course
